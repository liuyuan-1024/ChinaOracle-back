package com.liuyuan.chinaoracle.service.impl.reference;
...
import com.liuyuan.chinaoracle.mapper.PostFavourMapper;
import com.liuyuan.chinaoracle.mapper.PostMapper;
import com.liuyuan.chinaoracle.mapper.PostThumbMapper;
...
import com.liuyuan.chinaoracle.model.entity.reference.PostFavour;
import com.liuyuan.chinaoracle.model.entity.reference.PostThumb;
...
//                        log.info("delete post {}", delete);
    ...
    @Override
    public PostVO getPostVO(Post post, ServerWebExchange exchange) {
        ...
        // 2. 已登录，获取用户点赞、收藏状态
        User loginUser = userService.getLoginUserPermitNull(exchange);
        if (loginUser != null) {
            // 获取点赞
    ...
    @Override
    public Page<PostVO> getPostVOPage(Page<Post> postPage, ServerWebExchange exchange) {
        ...
        if (loginUser != null) {
            ...
            loginUser = userService.getLoginUser(exchange);
            // 获取点赞
            QueryWrapper<PostThumb> postThumbQueryWrapper = new QueryWrapper<>();
